...
__Depth__ is the length of the longest path from input to output but depends on the definition of what constitutes a possible computational step.<br>
Deep learning back to the 1940's. <br>
...
![ Illustration of a deep learning model.](../images/dlmodel.png) Figure 1.2: Illustration of a deep learning model. 

![Differents stages of AI](../images/stages.png)
...
Here are the key trends of deep learning: <br>
...
data has increased.<br>
• Deep learning models have grown in size over time as computer infrastructure
(both hardware and software) for deep learning has improved. <br>
